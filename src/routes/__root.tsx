...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Zest Photo Hub creates ephemeral event photo galleries. Guests upload photos via QR code." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Zest Photo Hub creates ephemeral event photo galleries. Guests upload photos via QR code." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Zest Photo Hub creates ephemeral event photo galleries. Guests upload photos via QR code." },
